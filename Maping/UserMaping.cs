...
namespace SpotifyTelegramBot.Maping
{
    public class UserMaping
    {
        ...
        // Static constructor to ensure the directory exists
        static UserMaping()
        {
            string jsonDirectory = Path.Combine(Directory.GetCurrentDirectory(), "json");
        ...
        {
            spotifyUsers = LoadUsersSubscribers();
